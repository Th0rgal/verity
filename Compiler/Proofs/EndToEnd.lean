...
theorem nativeIRRuntimeAgreesWithEvmYulLeanFuelWrapper_of_ok_agree
    ...
    (hAgree :
      yulResultsAgreeOn observableSlots native
        (Compiler.Proofs.YulGeneration.Backends.interpretYulRuntimeEvmYulLeanFuelWrapper fuel (Compiler.emitYul contract).runtimeCode
          (YulTransaction.ofIR tx) state.storage state.events)) :
    nativeIRRuntimeAgreesWithEvmYulLeanFuelWrapper fuel contract tx state observableSlots := by
  unfold nativeIRRuntimeAgreesWithEvmYulLeanFuelWrapper
  rw [hNative]
  exact hAgree
...
/-- Compatibility spelling for the current native call-dispatcher bridge
obligation. The definition body intentionally lives in
`nativeCallDispatcherAgreesWithEvmYulLeanFuelWrapper` because this boundary still
compares native `callDispatcher` projection with the EVMYulLean fuel wrapper. -/
...
def nativeDispatcherExecAgreesWithEvmYulLeanFuelWrapperPositive
  ...
  yulResultsAgreeOn observableSlots
    (Compiler.Proofs.YulGeneration.Backends.Native.projectResult
      (YulTransaction.ofIR tx) state.storage state.events nativeResult)
    (Compiler.Proofs.YulGeneration.Backends.interpretYulRuntimeEvmYulLeanFuelWrapper (Nat.succ fuel') (Compiler.emitYul contract).runtimeCode
      (YulTransaction.ofIR tx) state.storage state.events)
...
/-- Compatibility lift to `nativeCallDispatcherAgreesWithEvmYulLean`. -/
...
theorem nativeIRRuntimeAgreesWithEvmYulLeanFuelWrapper_of_lowered_callDispatcher_agree
    ...
    (hAgree :
      nativeCallDispatcherAgreesWithEvmYulLeanFuelWrapper fuel contract tx state
        observableSlots nativeContract) :
    nativeIRRuntimeAgreesWithEvmYulLeanFuelWrapper fuel contract tx state observableSlots := by
  apply nativeIRRuntimeAgreesWithEvmYulLeanFuelWrapper_of_ok_agree
  · exact
...
This bypasses the intermediate `callDispatcher` bridge when callers already
prove the generated dispatcher against `contractDispatcherExecResult`. -/
theorem nativeIRRuntimeAgreesWithEvmYulLeanFuelWrapper_of_lowered_dispatcherExec_positive_agree
    ...
    (hAgree :
      nativeDispatcherExecAgreesWithEvmYulLeanFuelWrapperPositive fuel' contract tx state
        observableSlots nativeContract) :
    nativeIRRuntimeAgreesWithEvmYulLeanFuelWrapper (Nat.succ fuel') contract tx state
      observableSlots := by
  apply nativeIRRuntimeAgreesWithEvmYulLeanFuelWrapper_of_ok_agree
  · exact
...
/-- Native Layer 3 generated-shape variant at the dispatcher-block boundary. -/
theorem layer3_contract_preserves_semantics_native_of_generated_dispatcherBlock_bridge
    (fuel : Nat) (contract : IRContract) (tx : IRTransaction)
    (initialState : IRState) (observableSlots : List Nat)
    (nativeContract : EvmYul.Yul.Ast.YulContract)
    (hselector : tx.functionSelector < selectorModulus)
...
theorem layer3_contract_preserves_semantics_native_of_generated_dispatcherExec_bridge
    (fuel : Nat) (contract : IRContract) (tx : IRTransaction)
    (initialState : IRState) (observableSlots : List Nat)
    (nativeContract : EvmYul.Yul.Ast.YulContract)
    (hselector : tx.functionSelector < selectorModulus)
...
/-- Compatibility spelling for the positive-fuel generated dispatcher-exec
Layer 3 bridge. -/
theorem layer3_contract_preserves_semantics_native_of_generated_dispatcherExec_positive
    ...
    (hFuel : fuel' = sizeOf (Compiler.emitYul contract).runtimeCode)
    (hPrefixUnique : Compiler.Proofs.YulGeneration.Backends.Native.generatedRuntimeFunctionNamesUnique
      ((if contract.usesMapping then [Compiler.mappingSlotFuncAt 0] else []) ++ contract.internalFunctions) = true)
    (hExternalBodies : ∀ fn, fn ∈ contract.functions →
      Compiler.Proofs.YulGeneration.Backends.Native.yulStmtsContainFuncDef fn.body = false)
    (hInternalBodies : ∀ name params rets body,
      Yul.YulStmt.funcDef name params rets body ∈ contract.internalFunctions →
...
dispatcher-block boundary. -/
theorem layers2_3_ir_matches_native_evmYulLean_of_generated_dispatcherBlock_bridge
    (fuel : Nat) (spec : CompilationModel.CompilationModel) (selectors : List Nat)
    (irContract : IRContract) (tx : IRTransaction) (initialState : IRState)
    (observableSlots : List Nat) (nativeContract : EvmYul.Yul.Ast.YulContract)
    (hCompile : CompilationModel.compile spec selectors = .ok irContract)
...
lowered-dispatcher exec. -/
theorem layers2_3_ir_matches_native_evmYulLean_of_generated_dispatcherExec_bridge
    (fuel : Nat) (spec : CompilationModel.CompilationModel) (selectors : List Nat)
    (irContract : IRContract) (tx : IRTransaction) (initialState : IRState)
    (observableSlots : List Nat) (nativeContract : EvmYul.Yul.Ast.YulContract)
    (hCompile : CompilationModel.compile spec selectors = .ok irContract)
...
theorem layers2_3_ir_matches_native_evmYulLean_of_generated_lowered_callDispatcher_body_closure
    (fuel : Nat) (spec : CompilationModel.CompilationModel) (selectors : List Nat)
    (irContract : IRContract) (tx : IRTransaction) (initialState : IRState)
    (observableSlots : List Nat) (nativeContract : EvmYul.Yul.Ast.YulContract)
    (hCompile : CompilationModel.compile spec selectors = .ok irContract)
...
theorem layers2_3_ir_matches_native_evmYulLean_of_generated_dispatcherExec_body_closure
  ...
  layers2_3_ir_matches_native_evmYulLean_of_generated_dispatcherBlock_body_closure
    ...
    hdispatchGuardSafe hNoHasSelector hHasSelectorDead hLoopFree hWF hNoFallback
    hNoReceive hFuel hLower hEnv
    (nativeDispatcherBlockAgreesWithEvmYulLean_of_exec_agree hNativeDispatcherExec)
...
/-- Compatibility spelling for the supported compiler-produced positive
dispatcher-exec theorem. -/
theorem layers2_3_ir_matches_native_evmYulLean_of_generated_dispatcherExec_positive
    ...
    nativeResultsMatchOn observableSlots (interpretIR irContract tx initialState)
      (Compiler.Proofs.YulGeneration.Backends.Native.interpretIRRuntimeNative
        (Nat.succ fuel') irContract tx initialState observableSlots) :=
  layers2_3_ir_matches_native_evmYulLean_of_generated_dispatcherExec_positive_bridge
    fuel' spec selectors irContract tx initialState observableSlots nativeContract
    hCompile hSupported hStaticParams hSafeBodies
    hselector hNoWrap hvars hmemory htransient hreturn hparamErase
...
shape from source-level static-scalar prologues and compiled statement-list closure. -/
...
theorem simpleStorageNativeRetrieveHitBridge_proved
  ...
  have hLayerFuel :
      Compiler.Proofs.YulGeneration.resultsMatch
        ...
        (Compiler.Proofs.YulGeneration.Backends.interpretYulRuntimeEvmYulLeanFuelWrapper (Nat.succ simpleStorageNativeDispatcherFuel)
          (Compiler.emitYul simpleStorageIRContract).runtimeCode
          (YulTransaction.ofIR tx) initialState.storage initialState.events) := by
...
theorem simpleStorageNativeSelectorMissBridge_proved
  ...
  · show yulResultsAgreeOn observableSlots _
      (Compiler.Proofs.YulGeneration.Backends.interpretYulRuntimeEvmYulLeanFuelWrapper simpleStorageNativeDispatcherFuel.succ
        (Compiler.emitYul simpleStorageIRContract).runtimeCode
        (YulTransaction.ofIR tx) initialState.storage initialState.events)
    have hFuelGoal :
...
theorem simpleStorage_endToEnd_native_evmYulLean_of_callDispatcher_bridge
  ...
  layer3_contract_preserves_semantics_native_of_generated_lowered_callDispatcher_bridge
    ...
    hselector hNoWrap hvars hmemory htransient hreturn hparamErase
    hdispatchGuardSafe hNoHasSelector hHasSelectorDead
    simpleStorage_functions_loop_free
...
/-- Native SimpleStorage wrapper with the remaining native obligation exposed
at raw lowered-dispatcher execution.

This is the preferred SimpleStorage seam for generated-fragment work: callers
prove agreement for `contractDispatcherExecResult` directly, and the generic
Layer 3 wrapper handles the block and `callDispatcher` restoration steps. -/
theorem simpleStorage_endToEnd_native_evmYulLean_of_dispatcherExec_bridge
    (tx : IRTransaction) (initialState : IRState) (observableSlots : List Nat)
    (hselector : tx.functionSelector < selectorModulus)
    (hNoWrap : 4 + tx.args.length * 32 < evmModulus)
    (hvars : initialState.vars = [])

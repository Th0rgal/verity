...
replacement coverage: universal bridge lemmas for all pure bridged builtins except `exp`, `sdiv`, `smod`, `slt`, `sgt`, `sar`, and `signextend`, plus concrete smoke tests for `exp`, `sdiv`, `smod`, `slt`, `sgt`, `sar`, and `signextend`.
-/

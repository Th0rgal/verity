...
def slotInReservedRange (slot : Nat) (range : ReservedSlotRange) : Bool :=
...
def rangesOverlap (a b : ReservedSlotRange) : Bool :=
...
def slotAliasSourcesOverlap (a b : SlotAliasRange) : Bool :=

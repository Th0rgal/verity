...
<p align="center">
  ...
  <a href="https://github.com/Th0rgal/verity"><img src="https://img.shields.io/badge/theorems-364-brightgreen.svg" alt="364 Theorems"></a>
...
cd verity
lake build                                    # Verifies all 364 theorems
...
364 theorems across 9 categories, all fully proven. 375 Foundry tests across 32 test suites. 220 covered by property tests (60% coverage, 144 proof-only exclusions). 2 documented axioms. 0 `sorry` — Ledger sum proofs completed in Conservation.lean ([#65](https://github.com/Th0rgal/verity/issues/65)).

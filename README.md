...
There is currently 1 documented Lean axiom in total: the mapping-slot range axiom. Selector computation is now kernel-computable, Layer 2's former generic body-simulation axiom has been eliminated, and Layer 3 keeps its remaining dispatch bridge as an explicit theorem hypothesis rather than a Lean axiom. See [AXIOMS.md](AXIOMS.md).

...
contract PropertyCounterTest is YulTestBase {
    ...
    function testAuto_PreviewOps_ReturnsInferredStraightLineResult() public {
        ...
        uint256 actual = abi.decode(ret, (uint256));
        assertEq(actual, ((uint256(2) > uint256(1)) ? (((((((((((2 > 0) ? 2 : 0) < 6) ? ((2 > 0) ? 2 : 0) : 6) * uint256(2)) / uint256(1)) * (((((((2 > 0) ? 2 : 0) < 6) ? ((2 > 0) ? 2 : 0) : 6) * uint256(1)) + (uint256(1) - 1)) / uint256(1))) / 1000000000000000000) * 1000000000000000000) + (uint256(1) - 1)) / uint256(1)) : ((((((((((((2 > 0) ? 2 : 0) < 6) ? ((2 > 0) ? 2 : 0) : 6) * uint256(2)) / uint256(1)) * (((((((2 > 0) ? 2 : 0) < 6) ? ((2 > 0) ? 2 : 0) : 6) * uint256(1)) + (uint256(1) - 1)) / uint256(1))) / 1000000000000000000) * 1000000000000000000) + (uint256(1) - 1)) / uint256(1)) - 1)), "previewOps should preserve the inferred result");
    }
}

...
- BN254 field lemmas: `SNARK_SCALAR_FIELD_ne_zero`, `SNARK_SCALAR_FIELD_lt_modulus`, `modField_nat_eq`, `modField_lt`, `modField_eq_self_of_lt` (`Verity/Proofs/Stdlib/Math.lean`)

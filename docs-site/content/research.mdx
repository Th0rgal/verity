...
- **Layer 3 (IR → Yul)**: In progress (generic equivalence scaffolding + Yul fuel‑unfolding lemmas + fuel‑bounded IR↔Yul sequence lemma + fuel‑bounded function lemma from aligned IR state; equivalence theorems not yet proven).

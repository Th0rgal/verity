...
## Progress and Roadmap (as of 2026-03-11)
...
- **Layer 2 (CompilationModel → IR)**: Supported-fragment generic theorem in place. The compiler-level theorem now lives in [`Compiler/Proofs/IRGeneration/Contract.lean`](https://github.com/Th0rgal/verity/blob/main/Compiler/Proofs/IRGeneration/Contract.lean); legacy bridge consumers in [`Contracts/Proofs/SemanticBridge.lean`](https://github.com/Th0rgal/verity/blob/main/Contracts/Proofs/SemanticBridge.lean) remain to be refactored and [#1510](https://github.com/Th0rgal/verity/issues/1510) now tracks fragment widening plus consumer migration.
...
- `Compiler/Proofs/IRGeneration/Contract.lean` — Generic whole-contract Layer 2 theorem for the current supported fragment

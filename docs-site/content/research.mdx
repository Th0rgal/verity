...
### What I Added
1. **Minimal Lean EDSL Core** (edsl/DumbContracts/Core.lean:1-58)
...
2. **SimpleStorage Example** (examples/lean/DumbContracts/Examples/SimpleStorage.lean:1-38)
...
- Created: edsl/DumbContracts/Core.lean
- Created: examples/lean/DumbContracts/Examples/SimpleStorage.lean
- Created: edsl/DumbContracts.lean
- Created: examples/solidity/SimpleStorage.sol
...
### What I Added
1. **Counter Example Contract** (examples/lean/DumbContracts/Examples/Counter.lean:1-50)
...
2. **Solidity Reference Implementation** (examples/solidity/Counter.sol:1-23)
...
### Files Modified This Iteration
- Created: examples/lean/DumbContracts/Examples/Counter.lean
- Created: examples/solidity/Counter.sol
- Created: test/Counter.t.sol
- Modified: examples/lean/DumbContracts/All.lean (added Counter import)
...
### What I Added
1. **Owned Example Contract** (examples/lean/DumbContracts/Examples/Owned.lean:1-59)
...
2. **Core Enhancement: Address Storage** (edsl/DumbContracts/Core.lean:23-52)
...
3. **Solidity Reference Implementation** (examples/solidity/Owned.sol:1-30)
...
### Files Modified This Iteration
- Created: examples/lean/DumbContracts/Examples/Owned.lean
- Created: examples/solidity/Owned.sol
- Created: test/Owned.t.sol
- Modified: edsl/DumbContracts/Core.lean (added Address storage)
- Modified: examples/lean/DumbContracts/All.lean (added Owned import)
- Modified: examples/lean/DumbContracts/Examples/SimpleStorage.lean (added storageAddr field)
- Modified: examples/lean/DumbContracts/Examples/Counter.lean (added storageAddr field)
...
### What I Added
1. **OwnedCounter Example Contract** (examples/lean/DumbContracts/Examples/OwnedCounter.lean:1-80)
...
2. **Solidity Reference Implementation** (examples/solidity/OwnedCounter.sol:1-43)
...
### Files Modified This Iteration
- Created: examples/lean/DumbContracts/Examples/OwnedCounter.lean
- Created: examples/solidity/OwnedCounter.sol
- Created: test/OwnedCounter.t.sol
- Modified: examples/lean/DumbContracts/All.lean (added OwnedCounter import)
...
### What I Added
1. **Math Safety Stdlib Module** (edsl/DumbContracts/Stdlib/Math.lean:1-63)
...
2. **SafeCounter Example** (examples/lean/DumbContracts/Examples/SafeCounter.lean:1-50)
...
3. **Solidity Reference** (examples/solidity/SafeCounter.sol:1-29)
...
### Files Modified This Iteration
- Created: edsl/DumbContracts/Stdlib/Math.lean
- Created: examples/lean/DumbContracts/Examples/SafeCounter.lean
- Created: examples/solidity/SafeCounter.sol
- Created: test/SafeCounter.t.sol
- Modified: examples/lean/DumbContracts/All.lean (added Stdlib.Math and SafeCounter imports)
...
### What I Added
1. **Mapping Storage in Core** (edsl/DumbContracts/Core.lean:25, 52-62)
...
2. **Ledger Example Contract** (examples/lean/DumbContracts/Examples/Ledger.lean:1-70)
...
3. **Solidity Reference** (examples/solidity/Ledger.sol:1-46)
...
### Files Modified This Iteration
- Modified: edsl/DumbContracts/Core.lean (added mapping storage +12 lines)
- Created: examples/lean/DumbContracts/Examples/Ledger.lean
- Created: examples/solidity/Ledger.sol
- Created: test/Ledger.t.sol
- Modified: examples/lean/DumbContracts/All.lean (added Ledger import)
...
### What I Added
1. **SimpleToken Example Contract** (examples/lean/DumbContracts/Examples/SimpleToken.lean:1-96)
...
2. **Solidity Reference** (examples/solidity/SimpleToken.sol:1-59)
...
### Files Modified This Iteration
- Created: examples/lean/DumbContracts/Examples/SimpleToken.lean
- Created: examples/solidity/SimpleToken.sol
- Created: test/SimpleToken.t.sol
- Modified: examples/lean/DumbContracts/All.lean (added SimpleToken import)

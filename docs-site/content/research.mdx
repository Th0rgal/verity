...
- `Verity/AST/X.lean` — Unified AST + equivalence proofs (`denote ast = edsl_fn`)
...
- `Verity/Specs/X/Proofs.lean` — Layer 2 re-export (imports from `Compiler/Proofs/SpecCorrectness/`)
...
- Test results: Foundry tests pass (398 as of 2026-02-18), Lean proofs verify (431 theorems as of 2026-02-19)
...
FOUNDRY_PROFILE=difftest forge test  # 398/375 tests pass (as of 2026-02-18)
```
...
- All Foundry tests passing (398 as of 2026-02-18)

...
- **Layer 2 (CompilationModel → IR)**: Supported-fragment generic theorem in place. The compiler-level theorem lives in [`Compiler/Proofs/IRGeneration/Contract.lean`](https://github.com/Th0rgal/verity/blob/main/Compiler/Proofs/IRGeneration/Contract.lean). The compiler proves Layer 2 preservation automatically for supported contracts. [#1510](https://github.com/Th0rgal/verity/issues/1510) now tracks fragment widening.

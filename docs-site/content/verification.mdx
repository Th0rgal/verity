...
description: 252 proven theorems across 7 contracts and stdlib
---

# Formal Verification

252 theorems proven across 7 contracts and a math stdlib. No `sorry`, no axioms. All proofs are checked by `lake build`.
...
2. Uint256 modeled as `Nat` (no overflow for basic arithmetic)

...
- EDSL theorems: 277 across 11 categories (10 contracts + ReentrancyExample + Stdlib).
...
- LocalObligationMacroSmoke: 4 total (Basic 3, Correctness 1; macro-local-obligation fixture).

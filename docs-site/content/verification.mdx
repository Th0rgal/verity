...
**Status**: 326 theorems across 9 categories, all fully proven. 0 `sorry` — Ledger sum proofs completed in Conservation.lean ([#65](https://github.com/Th0rgal/verity/issues/65)). 2 axioms documented in [AXIOMS.md](https://github.com/Th0rgal/verity/blob/main/AXIOMS.md).

## Snapshot (2026-02-17)

- EDSL theorems: 326 across 9 categories (7 contracts + ReentrancyExample + Stdlib).
...
- Stdlib: 90 theorems (Math 25, Automation 53, MappingAutomation 7; 2 shared between Automation and MappingAutomation).

...
**Lean Proofs**: All proofs verified (272 EDSL theorems, 100%)
```bash
$ lake build
Build completed successfully.
```

**Foundry Tests**: 475/475 passing (100%)
```bash
$ FOUNDRY_PROFILE=difftest forge test
Ran 38 test suites: 475 tests passed, 0 failed, 0 skipped (475 total tests)
```
...
- [Verification](/verification) — 272 tracked theorems (406 proven, 19 sorry)

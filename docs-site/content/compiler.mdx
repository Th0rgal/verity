...
# Expected: 302/302 tests pass (as of 2026-02-15)
```
...
**Lean Proofs**: All proofs verified (299 EDSL theorems, 100%)
```bash
$ lake build
Build completed successfully.
```

**Foundry Tests**: 302/302 passing (100%, as of 2026-02-15)
```bash
$ forge test
Ran 23 test suites: 302 tests passed, 0 failed, 0 skipped (302 total tests)
```
...
- [Verification](/verification) — 299 proven theorems

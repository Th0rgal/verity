...
**Lean Proofs**: All proofs verified (273 EDSL theorems, 100%)
```bash
$ lake build
Build completed successfully.
```

**Foundry Tests**: 478/478 passing (100%)
```bash
$ FOUNDRY_PROFILE=difftest forge test
Ran 38 test suites: 478 tests passed, 0 failed, 0 skipped (478 total tests)
```
...
- [Verification](/verification) — 273 tracked theorems (406 proven, 19 sorry)

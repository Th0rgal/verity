...
- **Compilation correctness**: `Compiler/TypedIRCompilerCorrectness.lean` + `Compiler/Proofs/IRGeneration/Contract.lean` for the current supported fragment. `Contracts/Proofs/SemanticBridge.lean` remains as a legacy/example wrapper layer.

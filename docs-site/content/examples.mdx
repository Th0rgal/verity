...
All contracts are in [`Contracts/`](https://github.com/Th0rgal/dumbcontracts/tree/main/Contracts). Specs live alongside each implementation (for example `Contracts/SimpleStorage/Spec.lean`), and proofs in each contract’s `Proofs/` folder.

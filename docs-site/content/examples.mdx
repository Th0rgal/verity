...
description: 12 contracts covering storage, arithmetic, access control, mappings, composition, and security
---
...
- **Compilation correctness**: `Verity/Core/Free/TypedIRCompilerCorrectness.lean` + `Compiler/Proofs/SemanticBridge.lean`
...
4. Prove spec adherence in `Verity/Proofs/<Name>/Basic.lean` using `Verity/Proofs/Stdlib/` helpers.
...
- Spec: [`Verity/Specs/ERC20/Spec.lean`](https://github.com/Th0rgal/verity/blob/main/Verity/Specs/ERC20/Spec.lean)
- Invariants: [`Verity/Specs/ERC20/Invariants.lean`](https://github.com/Th0rgal/verity/blob/main/Verity/Specs/ERC20/Invariants.lean)

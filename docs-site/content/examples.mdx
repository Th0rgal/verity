...
- **Spec**: `Contracts/<Name>/Spec.lean`
- **Invariants**: `Contracts/<Name>/Invariants.lean`
- **Implementation**: `Contracts/<Name>/<Name>.lean`
- **Basic proofs**: `Contracts/<Name>/Proofs/Basic.lean`
- **Advanced proofs**: `Contracts/<Name>/Proofs/Correctness.lean`

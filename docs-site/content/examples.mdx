...
All contracts are in [`examples/lean/DumbContracts/Examples/`](https://github.com/Th0rgal/dumbcontracts/tree/main/examples/lean/DumbContracts/Examples). Specs in `examples/lean/DumbContracts/Specs/`, proofs in `examples/lean/DumbContracts/Proofs/`.

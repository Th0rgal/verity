...
Every claim is machine-checked and every assumption is documented. The full
three-layer breakdown — what's verified at each stage and what remains in the
trust base — lives on the [Trust Model](/trust-model) page; the live theorem
inventory is on [Verification Status](/verification).
</ReportCallout>

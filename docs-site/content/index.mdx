...
**1. Specification** (`DumbContracts/Specs/SimpleToken/Spec.lean`)
```lean
-- What should mint do?
...
**2. Implementation** (`DumbContracts/Examples/SimpleToken.lean`)
```lean
...
**3. Proof** (`DumbContracts/Proofs/SimpleToken/Basic.lean`)
```lean

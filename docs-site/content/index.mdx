...
**Current status**: A compact EDSL core, verified example contracts, and automatic compilation to EVM bytecode. See [/verification](/verification) for current theorem counts and coverage.
...
**What's `sorry`?** A placeholder in Lean that says "I'll prove this later." It's how incomplete proofs compile. This project currently has 0 `sorry` placeholders across the proof modules.

**What are axioms?** Statements assumed true without proof. This project currently has 0 documented Lean axioms. See [AXIOMS.md](https://github.com/lfglabs-dev/verity/blob/main/AXIOMS.md) for details.
...
- [GitHub Repository](https://github.com/lfglabs-dev/verity): Source code
- [Build Status](https://github.com/lfglabs-dev/verity/actions): CI verification runs

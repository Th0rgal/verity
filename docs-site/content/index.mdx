...
**What are axioms?** Statements assumed true without proof. This project currently documents 1 Lean axiom: the mapping-slot range axiom in `Compiler/Proofs/MappingSlot.lean` (see [AXIOMS.md](https://github.com/Th0rgal/verity/blob/main/AXIOMS.md)). Selector hashing is now kernel-computable, the former generic Layer 2 body-simulation axiom has been eliminated, and the Layer 3 dispatch bridge is kept as an explicit theorem hypothesis rather than a Lean axiom.

...
**What are axioms?** Statements assumed true without proof. This project currently has 0 documented Lean axioms. See [AXIOMS.md](https://github.com/Th0rgal/verity/blob/main/AXIOMS.md) for details.

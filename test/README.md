...
**Coverage**: 220/359 theorems tested (61%), 139 proof-only exclusions documented in `property_exclusions.json`.
...
```
test/
├── Property*.t.sol           # Property tests (195 functions, covering 220/359 theorems)

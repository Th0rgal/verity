...
**Coverage**: 220/364 theorems tested (60%), 144 proof-only exclusions documented in `property_exclusions.json`.
...
```
test/
├── Property*.t.sol           # Property tests (195 functions, covering 220/364 theorems)

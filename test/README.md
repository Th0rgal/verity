...
**Coverage**: 250/272 theorems tested (92%), 22 proof-only exclusions documented in `property_exclusions.json`.
...
```
test/
├── Property*.t.sol           # Property tests (234 functions, covering 250/272 theorems)

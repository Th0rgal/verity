...
**Coverage**: 220/362 theorems tested (61%), 142 proof-only exclusions documented in `property_exclusions.json`.
...
```
test/
├── Property*.t.sol           # Property tests (195 functions, covering 220/362 theorems)

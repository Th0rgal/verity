...
REQUIRED_SNIPPETS = (
    ...
    "selected native-body lowering success",
    "without claiming native execution semantics",
    ...
    "smaller per-case lowering freshness premise",
    ...
    "remaining freshness work is to derive that per-case premise",
...
def check_public_theorem_target(
    ...
    for required_native_seam in (
        ...
        "theorem nativeGeneratedSwitchTempsFreshForNativeBodies_of_case_body_fresh",
        "theorem nativeGeneratedCallDispatcherMatchesIR_of_compile_ok_supported_with_selected_user_body_exec_only_and_bridgedStraightStmts_mappingFree_caseFresh",

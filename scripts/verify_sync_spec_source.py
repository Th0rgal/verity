...
SPEC = {'check_only_paths': ['.github/workflows/**',
 ...
 'expected_job_if_conditions': {'changes': None,
                                ...
                                'failure-hints': "always() && github.event_name == 'pull_request' "
                                                 ...
                                                 "'failure')"},
 'expected_job_runs_on': {'changes': '[self-hosted, linux, x64, verity, fastlane]',
                          'checks': '[self-hosted, linux, x64, verity, fastlane]',
                          'timeout-watchdog': '[self-hosted, linux, x64, verity, fastlane]',
                          ...
                          'failure-hints': '[self-hosted, linux, x64, verity, fastlane]'},

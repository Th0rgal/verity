            ...
            "helper_boundary": {
                ...
                "source_helper_goal_surface": {
                    ...
                    "status": (
                        ...
                        "CompiledStmtStepWithHelpers.withHelperIR_of_legacyCompatible / "
                        "stmtListGenericWithHelpersAndHelperIR_of_withHelpers_"
                        "and_compiledLegacyCompatible, and it now derives that "
                        "compiled-side witness on today's supported fragment "
                        "via stmtListCompiledLegacyCompatible_of_supportedContractSurface / "
                        "SupportedBodyInterface.compiledLegacyCompatible, so "
                        "already-proved helper-free cases can be reused in the "
                        "exact helper-aware compiled seam without a caller-"
                        "supplied witness on the current boundary; "
                ...
                "current_fail_closed_gate": (
                    ...
                    "The immediate blocker on today’s theorem domain is "
                        ...
                        "today's fragment; on the current boundary the "
                        "already-proved helper-free cases now lift into the "
                        "earlier helper-aware source seam automatically and "
                        "also into the exact compiled seam automatically, so "
                        "the remaining blocker there is only the genuinely new "
                        "helper-call reasoning. "
                        "The longer-term "

        ...
        "supported_spec_split": {
            ...
            "helper_boundary": {
                ...
                "compiled_target_compatibility_subset": {
                    ...
                    "status": "formalized_predicate_pending_conservative_extension_theorem",
                    "source": (
                        "Compiler.Proofs.IRGeneration.IRInterpreter."
                        "LegacyCompatibleExternalStmtList"
                    ),
                    "required_goal": (
                        "prove interpretIRWithInternals conservatively extends "
                        "interpretIR on the helper-free external-body Yul subset "
                        "generated by the current supported fragment"
                    ),
                },
                ...
                "next_required_proof_step": (
                    "first prove interpretIRWithInternals is a conservative "
                    "extension of interpretIR on the legacy-compatible "
                    "external-body Yul subset generated by the current "
                    "supported fragment for the helper-free runtime contracts "
                    "already built by Dispatch.runtimeContractOfFunctions, "
                ...
                "blocking_seams": [
                    ...
                    },
                    {
                        ...
                        "status": (
                            ...
                            "LegacyCompatibleExternalStmtList, and "
                            "Dispatch.runtimeContractOfFunctions now makes the "
                            "current helper-free runtime target explicit via "
                            "internalFunctions = []; the repo still needs the "
                            "explicit conservative-extension theorem over that "

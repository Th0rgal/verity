...
def main() -> None:
    ...
    expected_sorry = 189  # PR #1649 follow-up: 5 remaining SourceSemantics admissions + 184 remaining proof failures exposed by from-scratch build (FunctionBody, GenericInduction, Function)
    sorry_count = 0

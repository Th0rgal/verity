...
def main() -> None:
    ...
    expected_sorry = 199  # PR #1649 follow-up: 5 remaining SourceSemantics admissions + 194 remaining proof failures exposed by from-scratch build (FunctionBody, GenericInduction, Function, Dispatch, Contract)
    sorry_count = 0

...
def main() -> None:
    ...
    expected_sorry = 220  # 15 TypedIRCompilerCorrectness (Morpho admin tail) + 5 SourceSemantics (Lean 4.22 equation lemma heartbeat cap) + 3 FunctionBody (evalExpr Option Nat migration) + 149 GenericInduction + 41 Function + 7 Dispatch
    sorry_count = 0

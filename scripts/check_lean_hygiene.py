...
def main() -> None:
    ...
    expected_sorry = 197  # PR #1649 follow-up: 5 remaining SourceSemantics admissions + 192 remaining proof failures exposed by from-scratch build (FunctionBody, GenericInduction, Function, Dispatch, Contract)
    sorry_count = 0

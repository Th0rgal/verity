...
├── Stdlib/                    # Standard library for contracts ✅
└── Proofs/                    # Stdlib proofs ✅
    └── Stdlib/

Contracts/                     # User-style contract layout ✅
├── SimpleStorage/
│   ├── Impl.lean
│   ├── Spec.lean
│   ├── Invariants.lean
...
└── Proofs/                    # Compiler verification (infra + L2/L3) ✅
    ├── SpecInterpreter.lean   # ContractSpec semantics ✅
    ├── Automation.lean        # Common proof lemmas ✅

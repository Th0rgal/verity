...
- CI now runs `check_yul.py` + `check_gas_model_coverage.py` on `artifacts/yul-patched` as part of Issue #582 fail-closed hardening for patch-enabled output, including filename-set parity checks against baseline Yul output

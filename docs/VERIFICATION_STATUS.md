...
- [x] Complete Ledger sum property proofs — 0 `sorry` remaining (macro-generated semantic preservation placeholders, Issue #998), Ledger sums proven in Conservation.lean (Issue #65)

...
theorem constructor_meets_spec (s : ContractState) (initialOwner : Address) :
  ...
  simp [constructor, constructor_spec, owner]
...
theorem isOwner_meets_spec (s : ContractState) :
  ...
  simp [isOwner, isOwner_spec, msgSender, getStorageAddr, owner, Contract.run, DumbContracts.bind, DumbContracts.pure, ContractResult.fst]
  rfl
